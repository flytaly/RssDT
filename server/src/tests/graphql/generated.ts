...
export type ItemFieldsFragment = { __typename?: 'Item' } & Pick<
  Item,
  'id' | 'guid' | 'pubdate' | 'link' | 'title' | 'description' | 'summary' | 'imageUrl' | 'createdAt'
> & { enclosures?: Maybe<Array<{ __typename?: 'Enclosure' } & Pick<Enclosure, 'url' | 'length' | 'type'>>> };
...
export type UsualUserResponseFragment = { __typename?: 'UserResponse' } & {
  ...
  errors?: Maybe<Array<{ __typename?: 'ArgumentError' } & Pick<ArgumentError, 'message' | 'argument'>>>;
};
...
export type RequestEmailVerificationMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'requestEmailVerification'>;
...
export type SetLastViewedItemDateMutation = { __typename?: 'Mutation' } & {
  setLastViewedItemDate: { __typename?: 'UserFeed' } & Pick<UserFeed, 'id' | 'lastViewedItemDate' | 'newItemsCount'>;
};
...
export type UnsubscribeByTokenMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'unsubscribeByToken'>;
...
export type MeQuery = { __typename?: 'Query' } & { me?: Maybe<{ __typename?: 'User' } & UserFieldsFragment> };
...
export type MeWithOptionsQuery = { __typename?: 'Query' } & {
  me?: Maybe<
    { __typename?: 'User' } & { options: { __typename?: 'Options' } & OptionsFieldsFragment } & UserFieldsFragment
  >;
};
...
export type MyFeedItemsQuery = { __typename?: 'Query' } & {
  myFeedItems: { __typename?: 'PaginatedItemsResponse' } & Pick<PaginatedItemsResponse, 'count' | 'hasMore'> & {
...
export type MyFeedsQuery = { __typename?: 'Query' } & {
  myFeeds?: Maybe<
    Array<{ __typename?: 'UserFeed' } & { feed: { __typename?: 'Feed' } & FeedFieldsFragment } & UserFeedFieldsFragment>
  >;
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    activateFeed(variables: ActivateFeedMutationVariables, requestHeaders?: Headers): Promise<ActivateFeedMutation> {
      return withWrapper(() =>
        client.request<ActivateFeedMutation>(print(ActivateFeedDocument), variables, requestHeaders),
      );
    },
    addFeedToCurrentUser(
      ...
      return withWrapper(() =>
        client.request<AddFeedToCurrentUserMutation>(print(AddFeedToCurrentUserDocument), variables, requestHeaders),
      );
    },
    addFeedWithEmail(
      ...
      return withWrapper(() =>
        client.request<AddFeedWithEmailMutation>(print(AddFeedWithEmailDocument), variables, requestHeaders),
      );
    },
    deleteMyFeeds(variables: DeleteMyFeedsMutationVariables, requestHeaders?: Headers): Promise<DeleteMyFeedsMutation> {
      return withWrapper(() =>
        client.request<DeleteMyFeedsMutation>(print(DeleteMyFeedsDocument), variables, requestHeaders),
      );
    },
    ...
    requestPasswordReset(
      ...
      return withWrapper(() =>
        client.request<RequestPasswordResetMutation>(print(RequestPasswordResetDocument), variables, requestHeaders),
      );
    },
    resetPassword(variables: ResetPasswordMutationVariables, requestHeaders?: Headers): Promise<ResetPasswordMutation> {
      return withWrapper(() =>
        client.request<ResetPasswordMutation>(print(ResetPasswordDocument), variables, requestHeaders),
      );
    },
    setFeedOptions(
      ...
      return withWrapper(() =>
        client.request<SetFeedOptionsMutation>(print(SetFeedOptionsDocument), variables, requestHeaders),
      );
    },
    setLastViewedItemDate(
      ...
      return withWrapper(() =>
        client.request<SetLastViewedItemDateMutation>(print(SetLastViewedItemDateDocument), variables, requestHeaders),
      );
    },
    ...
    unsubscribeByToken(
      ...
      return withWrapper(() =>
        client.request<UnsubscribeByTokenMutation>(print(UnsubscribeByTokenDocument), variables, requestHeaders),
      );
    },
    updateUserInfo(
      ...
      return withWrapper(() =>
        client.request<UpdateUserInfoMutation>(print(UpdateUserInfoDocument), variables, requestHeaders),
      );
    },
    ...
    getFeedInfoByToken(
      ...
      return withWrapper(() =>
        client.request<GetFeedInfoByTokenQuery>(print(GetFeedInfoByTokenDocument), variables, requestHeaders),
      );
    },
