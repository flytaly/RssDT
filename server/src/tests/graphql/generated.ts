  ...
  addFeedToCurrentUser: {
    ...
    userFeed?:
      | {
          ...
          id: number;
          activated: boolean;
          feed: { __typename?: 'Feed'; id: number; url: string };
        }
      | null
      | undefined;
    errors?:
...
export type VerifyEmailMutation = {
  ...
  verifyEmail: {
    __typename?: 'UserResponse';
    user?:
      | { __typename?: 'User'; id: number; email: string; emailVerified: boolean }
      | null
      | undefined;
    errors?: Array<{ __typename?: 'ArgumentError'; message: string }> | null | undefined;
  };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    meWithFeeds(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MeWithFeedsQuery>(MeWithFeedsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'meWithFeeds',
    ...
    meWithOptions(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<MeWithOptionsQuery>(MeWithOptionsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'meWithOptions',
