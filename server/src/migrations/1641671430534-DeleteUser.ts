...
export class DeleteUser1641671430534 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "users_to_be_deleted" ("userId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_1f88ec09e6eb6d221ad761fd5a" UNIQUE ("userId"), CONSTRAINT "PK_1f88ec09e6eb6d221ad761fd5a1" PRIMARY KEY ("userId"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users_to_be_deleted" ADD CONSTRAINT "FK_1f88ec09e6eb6d221ad761fd5a1" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "users_to_be_deleted" DROP CONSTRAINT "FK_1f88ec09e6eb6d221ad761fd5a1"`,
    );
    await queryRunner.query(
