...
export class Initial1613520876770 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "options" ("userId" integer NOT NULL, "dailyDigestHour" integer NOT NULL DEFAULT '18', "withContentTableDefault" boolean NOT NULL DEFAULT false, "itemBodyDefault" boolean NOT NULL DEFAULT true, "attachmentsDefault" boolean NOT NULL DEFAULT true, "themeDefault" "options_themedefault_enum" NOT NULL DEFAULT 'default', "customSubject" character varying(150), "shareEnable" boolean NOT NULL DEFAULT true, "shareList" character varying array DEFAULT '{}', CONSTRAINT "REL_54ac67a573667d2e37a8752e89" UNIQUE ("userId"), CONSTRAINT "PK_54ac67a573667d2e37a8752e89d" PRIMARY KEY ("userId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_feed" ADD CONSTRAINT "FK_0021f4ccb06709332ad8d7b234a" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_feed" ADD CONSTRAINT "FK_17a59ca657fe2edc39e523b7a63" FOREIGN KEY ("feedId") REFERENCES "feed"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "enclosure" ADD CONSTRAINT "FK_3e63f37d8a06b34ae6856efdef3" FOREIGN KEY ("itemId") REFERENCES "item"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "enclosure" DROP CONSTRAINT "FK_3e63f37d8a06b34ae6856efdef3"`,
    );
    await queryRunner.query(`ALTER TABLE "item" DROP CONSTRAINT "FK_400d419e53b4cc8083508591a89"`);
    await queryRunner.query(
      `ALTER TABLE "user_feed" DROP CONSTRAINT "FK_17a59ca657fe2edc39e523b7a63"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_feed" DROP CONSTRAINT "FK_0021f4ccb06709332ad8d7b234a"`,
    );
    await queryRunner.query(
